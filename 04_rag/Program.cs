...
const string prompt =
    """
    Please create a simple "Hello World" web server with a single endpoint "/work". In the handler func for "/work", fire off a long running task. 
    Make sure that the generated code uses the latest http.ServeMux features in Go 1.26.
    """;
