...
// NEW: UserInfo is our C# representation of the user information we want to store in memory. 
// In this example, it's just a string of additional instructions, but it could be any data structure that makes sense for your application. 
public class UserInfo
{
    public string? AdditionalInstructions { get; set; }
}

// NEW: UserInfoMemory is our implementation of an AIContextProvider that extracts user information from the user's messages and injects 
